...
namespace UserControlSystem.UI.Presenter
{
    public sealed class CommandButtonsPresenter : MonoBehaviour
    {
        ...
        private void ONButtonClick(ICommandExecutor commandExecutor)
        {
            ...
            if (attack != null)
            {
                attack.ExecuteSpecificCommand(new AttackCommand());
                return;
            }
            ...
            if (move != null)
            {
                move.ExecuteSpecificCommand(new MoveCommand());
                return;
            }
            ...
            if (patrol != null)
            {
                patrol.ExecuteSpecificCommand(new PatrolCommand());
                return;
            }
            ...
            if (stop != null)
            {
                stop.ExecuteSpecificCommand(new StopCommand());
                return;
            }
